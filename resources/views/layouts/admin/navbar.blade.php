  ...
  !-->
                            <li class="nav-item dropdown notification-list">
                                <a class="nav-link dropdown-toggle arrow-none waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                                   aria-haspopup="false" aria-expanded="false">
                                    <img src="{{url('../avatar-1.jpg')}}" alt="user" class="img-circle">
                                </a>


                                <div class="dropdown-menu dropdown-menu-right dropdown-arrow profile-dropdown " aria-labelledby="Preview">
                                    <div class="dropdown-item noti-title">
                                        <h5 class="text-overflow"><small>Welcome ! Maher</small> </h5>
                                    </div>
                    ...
                    <div id="navigation">
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu">
                             <a href=""><i class="zmdi zmdi-case"></i> <span> Workers </span> </a>
                            <ul class="submenu">
                                <li>
                                    <a href="/interface/jobs"><i class=""></i>Add Worker</a>
                                </li>

                                <li>
                                    <a href="/interface/jobs/show"><i class=""></i>Show Workers</a>
                                </li>
                            </ul>
                            <li>
                             <a href="interface/application"><i class="zmdi zmdi-money"></i> <span> Payments </span></a>
                            </li>
                            <li class="has-submenu">
